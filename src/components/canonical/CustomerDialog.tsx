...
export function CustomerDialog(props: {
  ...
  const form = useForm<CustomerFormValues>({ resolver: zodResolver(Schema), defaultValues })
  ...
  return (
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>{props.value ? "Editar cliente" : "Novo cliente"}</DialogTitle>
        </DialogHeader>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              <Label>Nome Conhecido</Label>
              <Input placeholder="Apelido / Fantasia" {...form.register("knownName")} />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              <Label>Bairro</Label>
              <Input placeholder="Bairro" {...form.register("neighborhood")} />
            </div>
            <div className="space-y-2">
              <Label>Valor</Label>
              <Input type="number" step="0.01" placeholder="0,00" {...form.register("value", { valueAsNumber: true })} />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between rounded-md border p-3">
            <div>
              ...
              <div className="text-xs text-muted-foreground">Clientes inativos ficam ocultos nas seleções.</div>
            </div>
          ...
          {form.watch("isActive") === false ? (
            <div className="space-y-2">
              ...
              <Input placeholder="Informe o motivo..." {...form.register("deactivationReason")} />
            </div>
          ) : null}
