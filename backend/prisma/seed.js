...
import { PrismaClient, UserRole, TransactionStatus, TransactionType, PendencyPriority, PendencyStatus, PendencyType, ImportSource, ImportStatus, LedgerOperation, ChartPlanType, RevenueExpense, DebitCredit, FixedVariable, CostExpense, } from "@prisma/client";
import bcrypt from "bcryptjs";
const prisma = new PrismaClient();
const toDate = (isoDate) => new Date(isoDate);
async function main() {
